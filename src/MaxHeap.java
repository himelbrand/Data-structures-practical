public class MaxHeap extends Heap {
    /**
     * Constructs an empty max binary heap with max size of k
     * @param k
     */
    ...
    /**
     * Construct the max binary heap given an array of items.
     * @param array
     */
    public MaxHeap(Point[] array)
    {
        size = array.length;
    ...
    public Point[] getFirstK(int k) {
        ...
        IndexMaxHeap temp=new IndexMaxHeap(k);
